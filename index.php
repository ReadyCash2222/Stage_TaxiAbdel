...
<body class="flex">
	...
	<nav id="navBar" class="flex">
		<div class="blocNav">
			...
			<div id="numTelNav" class="flex">
				...
				<div id="logoTel">
					<a href="tel:+0631752852"><img src="/images/tellogloblanc.png"
							alt="logo telephone blanc"></a>
				</div>
	...
	<div>
		<button onclick="topFunction()" id="myBtn"><img src="/images/icons8-fleche-haut-64.png"
				alt="fleche vers le haut"></button>
	</div>
				...
				<div class="firstP">
					<p style="letter-spacing: 1px; text-align: justify;">Réserver un taxi
						conventionné en appelant le <a href="tel:+0631 752852"
							class="linkNum unselectable"><b>06 31 75 28 52</b></a>, à cette
						adresse mail
						<a href="mailto:taxiabdel1978@gmail.com"
							class="linkNum unselectable"><b>taxiabdel1978@gmail.com</b></a>
						ou en quelques
			...
			<div class="form1">
				<form action="index.php" method="POST" id="formReservation" class="flex">
					...
					<div class="input2div"><input type="text" id="adr_des" name="adr_des"
							class="input1" required placeholder="Adresse + Ville (CP)">
					</div>
