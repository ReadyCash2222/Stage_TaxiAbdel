	...
	<nav id="navBar" class="flex">
		<div class="blocNav">
			...
			<div id="numTelNav" class="flex">
				...
				<div id="logoTel">
					<a href="tel:+0631752852"><img src="/images/tellogloblanc.png" alt="logo telephone blanc"></a>
				</div>
				<div class="numberTel unselectable"><a href="tel:+0631752852">06 31 75 28 52</a></div>
		...
		<div class="flex firstBlock">
			<div class="flex" id="divTitre" style="flex-wrap:wrap">
				...
				<div class="firstP">
					<p style="letter-spacing: 1px; text-align: justify;">Réservez un taxi
						...
						vous dépose sur votre lieu rendez-vous.
					</p>
				</div>
			</div>
			...
			<div class="form1">
				<form action="index.php" method="POST" id="formReservation" class="flex">
					...
					<div class="input2div"><input type="text" id="prenom" name="prenom" class="input1" required placeholder="Prénom*"></div>

					<div class="flex" style="margin-bottom: 10px;"><label></label>
					</div>
					<div class="input2div"><input type="text" id="nom" name="nom" class="input1" required placeholder="Nom*"></div>

					<div class="flex" style="margin-bottom: 10px;"><label></label>
					</div>
					<div class="input2div"><input type="email" id="email_addr" name="email_addr" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="input1" placeholder="email@email.fr*"></div>
					...
					<div class="input2div"><input type="email" id="email_addr_repeat" name="email_addr_repeat" required oninput="check(this)" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="input1" placeholder="email@email.fr*"></div>

					<div class="flex" style="margin-top: 15px;"><label>Numéro de sécurité sociale :
						</label></div>
					<div class="input2div"><input type="text" id="num_secu" name="num_secu" class="input1" placeholder="1 23 45 67 890 123" maxlength="13">
					</div>
					...
					<div class="input2div"><input type="text" id="adr_dep" name="adr_dep" required class="input1" placeholder="Adresse + Ville (CP)"></div>

					<div class="flex" style="margin-top: 15px;"><label>Date :</label>
						<div style="color: rgb(255, 0, 0); padding-left: 2px;">*
						</div>
					</div>
					<div class="input2div"><input type="date" id="date" name="date" class="input1" required><span class="open-button">
					...
					<div class="input2div"><input type="text" id="adr_des" name="adr_des" class="input1" required placeholder="Adresse + Ville (CP)">
					</div>
					...
					<div class="input2div"><input type="text" id="heure" name="heure" class="input1" required placeholder="9h25"></div>

					<div class="input2div" style="margin-top: 10px; margin-bottom: 10px;"><input type="submit" name="submit" value="Effectuer la réservation" class="submit2" id="btnForm1" />
					</div>
				</form>
				<?php
		...
		<div class="blocBlanc2 flex">
			...
			<div id="fifth_SecondItem" class="flex">
				<div id="leftItem">
					...
					<div>
						<p class="unselectable">aboumeymoun@hotmail.fr</p>
					</div>

					<div>
						<p>Tél : <b class="unselectable">06 31 75 28
								52</b>
						</p>
					</div>
	...
	<footer id="footer" class="flex">
		...
		<div id="footerBar" class="flex">
			...
			<details>
				...
				<p style="text-align:center">Taxi Abdel, taxi abdel, taxiabdel,
					taxi conventionné,
					transport taxi,
					taxi ameli,
					conventionné taxi, réserver taxi, réserver taxi conventionné, réserver taxi abdel,
